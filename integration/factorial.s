...
.LFE12:
	.end	tig_getchar
        ...
        .globl  tig_exit_TigMain
        .ent    tig_exit_TigMain
        .data
derefNilRecord_str:
        .asciiz "Attempted dereferencing of nil record.\n"
indexOutOfBounds_str:
...
tig_exit_TigMain:
        ...
        li $t1, -2
        beq $a0, $t0, deref_Lab
        beq $a0, $t0, outOfBounds_Lab
        b return_Lab
deref_Lab:
        la $a0, derefNilRecord_str
        li $v0, 4
        syscall
        b return_Lab
outOfBounds_Lab:
...
.text
tig_dereference_NIL:
tig_dereference_NIL_framesize=8
addi $sp, $sp, -8
L4108:
addi $t0, $sp, tig_dereference_NIL_framesize
sw $ra, -4($t0)
li $a0, -1
...
jr $ra
tig_outOfBounds:
tig_outOfBounds_framesize=8
addi $sp, $sp, -8
L4110:
addi $t0, $sp, tig_outOfBounds_framesize
sw $ra, -4($t0)
li $a0, -2
jal tig_exit_TigMain
addi $t0, $sp, tig_outOfBounds_framesize
...
jr $ra
tig_main:
tig_main_framesize=12
addi $sp, $sp, -12
L4114:
addi $t0, $sp, tig_main_framesize
sw $ra, -4($t0)
addi $t0, $sp, tig_main_framesize
sw $a0, 0($t0)
addi $a0, $sp, tig_main_framesize
li $a1, 10
jal L4103
addi $t0, $sp, tig_main_framesize
lw $ra, -4($t0)

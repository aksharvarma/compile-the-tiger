...
\\001\000\005\000\129\000\013\000\134\000\000\000\
...
\\001\000\007\000\070\000\038\000\105\000\000\000\
...
\\001\000\007\000\072\000\015\000\031\000\016\000\030\000\017\000\029\000\
...
\\026\000\020\000\038\000\106\000\000\000\
...
\\149\000\010\000\019\000\014\000\018\000\027\000\017\000\000\000\
\\150\000\000\000\
\\151\000\000\000\
\\152\000\000\000\
\\153\000\000\000\
...
\\182\000\000\000\
\\183\000\039\000\111\000\000\000\
\\184\000\000\000\
...
\\019\000\027\000\020\000\026\000\021\000\025\000\022\000\024\000\
\\023\000\023\000\024\000\022\000\025\000\021\000\026\000\020\000\000\000\
\\187\000\002\000\016\000\003\000\015\000\004\000\014\000\008\000\013\000\
\\016\000\012\000\029\000\011\000\032\000\010\000\033\000\009\000\
\\036\000\008\000\040\000\007\000\041\000\006\000\000\000\
...
\\023\000\023\000\024\000\022\000\025\000\021\000\026\000\020\000\000\000\
\\194\000\000\000\
\\195\000\044\000\062\000\000\000\
\\196\000\000\000\
\\197\000\042\000\080\000\000\000\
\\198\000\000\000\
\\199\000\000\000\
\\200\000\000\000\
\\201\000\000\000\
\\202\000\000\000\
\\203\000\000\000\
\\204\000\002\000\120\000\000\000\
\\205\000\000\000\
\\206\000\000\000\
\\207\000\000\000\
\\208\000\000\000\
...
\\094\000\093\000\092\000\095\000\
\\013\000\014\000\015\000\008\000\
\\009\000\009\000\009\000\067\000\
\\009\000\066\000\009\000\024\000\
\\087\000\043\000\038\000\025\000\
\\085\000\081\000\015\000\096\000\
\\044\000\028\000\104\000\036\000\
\\033\000\035\000\074\000\040\000\
\\071\000\069\000\083\000\082\000\
\\088\000\016\000\009\000\080\000\
\\056\000\009\000\105\000\017\000\
\\009\000\018\000\101\000\076\000\
\\075\000\009\000\009\000\045\000\
\\089\000\009\000\086\000\097\000\
\\050\000\101\000\098\000\108\000\
\\048\000\026\000\029\000\042\000\
\\070\000\009\000\077\000\019\000\
\\027\000\009\000\030\000\020\000\
\\021\000\009\000\090\000\100\000\
\\099\000\109\000\009\000\022\000\
\\031\000\102\000\072\000\106\000\
\\046\000\023\000\009\000\103\000\
\\107\000\000\000"
val gotoT =
"\
\\001\000\145\000\002\000\003\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\009\000\059\000\010\000\058\000\013\000\057\000\015\000\056\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\002\000\074\000\003\000\002\000\006\000\001\000\000\000\
\\002\000\076\000\003\000\002\000\005\000\075\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\002\000\108\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\002\000\110\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\011\000\111\000\000\000\
\\002\000\115\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\012\000\117\000\000\000\
\\000\000\
\\000\000\
\\002\000\119\000\003\000\002\000\006\000\001\000\000\000\
\\002\000\120\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\002\000\122\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\002\000\130\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\002\000\133\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\002\000\139\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\002\000\144\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\"
...
|  ( 6, ( ( _, ( MlyValue.expr expr1, exprleft, expr1right)) :: ( _, (
 _, MINUS1left, _)) :: rest671)) => let val  result = MlyValue.expr
...
EQleft, _)) :: ( _, ( MlyValue.ID ID1, ID1left, _)) :: rest671)) =>
 let val  result = MlyValue.recordFields (fn _ => let val  (ID as ID1)
 = ID1 ()
 val  (expr as expr1) = expr1 ()
 in ([(sym(ID), expr, EQleft)])
end)
 in ( LrTable.NT 6, ( result, ID1left, expr1right), rest671)
end
|  ( 45, ( ( _, ( MlyValue.expr expr1, _, expr1right)) :: ( _, ( _, 
EQleft, _)) :: ( _, ( MlyValue.ID ID1, _, _)) :: _ :: ( _, ( 
...
recordFields as recordFields1) = recordFields1 ()
 val  (ID as ID1) = ID1 ()
 val  (expr as expr1) = expr1 ()
 in (recordFields@[(sym(ID), expr, EQleft)])
end)
...
MlyValue.fundecs (fn _ => let val  (fundec as fundec1) = fundec1 ()
 in ([fundec])
end)
 in ( LrTable.NT 14, ( result, FUNCTION1left, fundec1right), rest671)

end
|  ( 60, ( ( _, ( MlyValue.fundec fundec1, _, fundec1right)) :: _ :: (
 _, ( MlyValue.fundecs fundecs1, fundecs1left, _)) :: rest671)) => let
 val  result = MlyValue.fundecs (fn _ => let val  (fundecs as fundecs1
) = fundecs1 ()
...
tyfields1, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, ID1left, _)) :: 
...
COLONleft, _)) :: ( _, ( MlyValue.ID ID1, _, _)) :: ( _, ( _, VAR1left
